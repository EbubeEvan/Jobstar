    ...
    <SafeAreaView className="flex-1 bg-white p-10">
      ...
      <View className="mt-20">
        ...
        <View className="mt-10 mb-5">
          ...
          <TouchableOpacity className="mt-10 py-2 w-full h-14 bg-blue-500 flex flex-row justify-center align-middle rounded-md" onPress={login}>
            <Text className="text-lg text-white ">{loading ? <ActivityIndicator className="text-white"/> : 'Login'}</Text>
          </TouchableOpacity>
        </View>
